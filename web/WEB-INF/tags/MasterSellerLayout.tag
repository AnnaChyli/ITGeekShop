                        ...
                        <div class="col-sm-8 col-xs-12">
                            <div class="header-links">
                                <ul class="nav navbar-nav pull-left">
                                    <li>
                                        <a href="<c:url value="/inventory/inventory.htm"/>" >
                                    ...
                                    <sec:authorize access="isAuthenticated()">
                                            ...
                                            <i class="fa fa-home hidden-lg hidden-md" title="Logout"></i>
                                            <span class="hidden-sm hidden-xs">
                                                Logout
                                            </span>
                                            </a>
            ...
            <div class="main-header">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div id="logo">
                                <a href="<c:url value="/inventory/inventory.htm"/>" ><img src="<c:url value="/resources/images/logo.jpg" />" title="ITGeekShop" alt="ITGeekShop" class="img-responsive" /></a>
                            </div>
                        </div>
                        <!-- Logo Starts -->				
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-cat-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="<c:url value="/inventory/addNewProduct.htm"/>">Add a New Item </a></li>
                            <li><a href="<c:url value="/inventory/financeInfo.htm"/>">Show Finance Info </a></li>
            ...
            <footer id="footer-area">
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-4 col-sm-12 last">
                            ...
                            <ul>
                                ...
                                <li>
                                    Email: <a href="#">mguerri8@fau.edu</a>
                                </li>								
                            </ul>
                            <h4 class="lead">
                                Tel: <span>1(561) 297-3000</span>
                            </h4>
                        </div>
                        <!-- Contact Us Ends -->
                    </div>
                ...
                <div class="copyright">
                    ...
                    <div class="container">
                        <!-- Starts -->
                        <p class="pull-left">
                            &copy; 2015 IT Geek Shop. Designed By <a href="http://forbes.com">gchyli</a>
                        </p>
                        <!-- Ends -->
